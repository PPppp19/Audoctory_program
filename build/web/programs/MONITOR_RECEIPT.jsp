...
<html>
    ...
    <body>
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="vID" id="vID"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">CONO : </label>
            <input type="text" name="vCONO" id="vCONO"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">DIVI : </label>
            <input type="text" name="vDIVI" id="vDIVI"  style=" color: #b356b5;"/>

            <button class="btn btn-success"  id="sID" name="sID" type="button">SEARCH ID</button>
        ...
        <div class="col-md-12">
            ...
            <label style=" color: #000000;">RCNO : </label>
            <input type="text" name="vRCNO" id="vRCNO"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">CONO : </label>
            <input type="text" name="vCONORCNO" id="vCONORCNO"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">DIVI : </label>
            <input type="text" name="vDIVIRCNO" id="vDIVIRCNO"  style=" color: #b356b5;"/>

            <button class="btn btn-success"  id="sRCNO" name="sRCNO" type="button">SEARCH RCNO</button>

            <br>
            <br> <br>
            <div id="jsGridRCNO"></div>
        ...
        <hr>
        <div class="col-md-12">
            <label style=" color: #000000;">BANK MAPPING : </label>

            <br>
            <br>
            <div id="jsGridBM2"></div>
            <br><!-- comment -->
            <br>


            <label style=" color: #000000;">CONO : </label>
            <input type="text" name="vCONOBM" id="vCONOBM"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">DIVI : </label>
            <input type="text" name="vDIVILBM" id="vDIVILBM"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">BANK : </label>
            <input type="text" name="vBANKBM" id="vBANKBM"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">DATE : </label>
            <input type="text" name="vDATEBM" id="vDATEBM"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">TIME : </label>
            <input type="text" name="vTIMEBM" id="vTIMEBM"  style=" color: #b356b5;"/>

            <label style=" color: #000000;">AMOUNT : </label>
            <input type="text" name="vAMOUNTBM" id="vAMOUNTBM"  style=" color: #b356b5;"/>

            <button class="btn btn-success"  id="sBM" name="sBM" type="button">SEARCH BM</button>
